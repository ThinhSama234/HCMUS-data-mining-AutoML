...
per the approved mockup. Console is a product track separate from spec 002's task list, but it
now hosts US6 (the former standalone `dashboard/app.py` was consolidated here).
"""
