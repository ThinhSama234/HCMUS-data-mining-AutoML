...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{3.1cm} >{\raggedright\arraybackslash}p{2.4cm} X@{}}
    ...
    {[}tên công cụ nếu có{]} &
    {[}Nêu phạm vi hỗ trợ khi xây dựng sổ tay phân tích và sinh biểu đồ; nhóm đã
    kiểm tra tính nhất quán giữa từng biểu đồ và dữ liệu gốc. Ghi ``không sử
    dụng'' nếu phần này do nhóm tự thực hiện hoàn toàn.{]} \\
    \bottomrule
  \end{tabularx}
\end{table}
