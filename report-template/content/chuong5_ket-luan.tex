...
Như đã ghi nhận ở Mục~\ref{sec:baseline}, bộ dự đoán hằng mới hoàn tất trên ba bộ
dữ liệu và rừng ngẫu nhiên chưa cho kết quả nào do lớp bao phương pháp cơ sở
chuyển thẳng dữ liệu thô cho bộ ước lượng mà không mã hoá biến hạng mục. Khắc phục
điểm này không đòi hỏi thay đổi giao thức: chỉ cần bổ sung một bước tiền xử lý tối
thiểu và đồng nhất --- mã hoá one-hot cho biến hạng mục và điền giá trị khuyết
bằng trung vị --- vào đúng lớp bao đó, rồi chạy lại trên toàn bộ 12 bộ dữ liệu.
