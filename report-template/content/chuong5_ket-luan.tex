...
\textbf{Về tuyến phương pháp cơ sở.} Việc đối chiếu với các phương pháp cơ sở chưa
được triển khai ở quy mô như thiết kế ban đầu, do giới hạn về tài nguyên tính toán
mà nhóm huy động được trong khuôn khổ đồ án. Kết quả thu được đủ để khẳng định các
thư viện AutoML thực sự khai thác được thông tin từ đặc trưng, song chưa đủ để
lượng hoá phần giá trị gia tăng của chúng so với một lựa chọn thủ công hợp lý ---
vốn là câu hỏi mang tính thực tiễn cao hơn. Phạm vi đã thực hiện được trình bày
chi tiết ở Mục~\ref{sec:baseline}.
