# =============================================================================
# NOTEBOOK C — FLAML + MLJAR
# All 14 datasets × 5 folds × 2 frameworks
...
# CELL 5 — Install FLAML + MLJAR
# -----------------------------------------------------------------------------
!pip install flaml[automl] mljar-supervised -q
print("FLAML + MLJAR installed.")


# CELL 6 — Run benchmark
# -----------------------------------------------------------------------------
!python scripts/orchestrator.py \
    --frameworks flaml mljar \
    --time-budget 60 \
    --no-venv \
    --run-id run_flaml_mljar
...
import glob
for f in glob.glob("reports/run_flaml_mljar*.json"):
    files.download(f)

# Option B: save to Google Drive
# from google.colab import drive
# drive.mount('/content/drive')
# !cp reports/run_flaml_mljar*.json /content/drive/MyDrive/automl_reports/
